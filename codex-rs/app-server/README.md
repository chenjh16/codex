...
- `thread/suggestNextPrompt` — sample a filtered next-prompt suggestion for a loaded thread without starting a turn. This is an internal TUI helper, not a general conversation mutation API.
